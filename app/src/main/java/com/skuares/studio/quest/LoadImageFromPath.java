 ...
 */
public class LoadImageFromPath {
    ...
    */
    ...
    public void loadBitmap(String path, ImageView imageView) {
        if (cancelPotentialWork(path, imageView)) {
            ...
            */
            task.execute(path,reqW,reqH);

            Log.e("MYVALUES", String.valueOf("Width "+reqH +" HEIGHT"+ reqH));
    ...
    class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... params) {
            ...
            return decodeSampledBitmapFromPath(data, rW, rH); // SHOULD BE IMAGE View WIDTH and Height
        }
